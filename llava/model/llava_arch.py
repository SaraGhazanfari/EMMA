...
class LlavaMetaForCausalLM(ABC):
    ...
    # def encode_images(self, images, instruct=None):
    #     image_features, text_features = self.get_model().get_vision_tower()(images, instruct)
    #     image_features = self.get_model().mm_projector(image_features)
    #
    #     infused_image_features = torch.cat((image_features, text_features), dim=1)
    #     infused_image_features = self.get_model().get_vision_tower().image_text_infusion(
    #         infused_image_features.permute(0, 2, 1)).permute(0, 2, 1)
    ...
    def prepare_inputs_labels_for_multimodal(
            ...
            images, image_sizes=None, prompt_input_ids=None
    ):
